...
<!--    <form class="register-form">
    ...
    <form action = "" method = "post">
                  <input type = "text" name = "username" class = "box" placeholder="user name"/><br /><br />
                  <input type = "password" name = "password" class = "box" placeholder="password"/><br/><br />
                  <input type = "submit" value = " Login "/><br />
                  <p class="message"> Register a new account. <a href="register.php">Register</a></p>
               </form>
  </div>
</div>
...
//         session_register("login_user");
         ...
         $_SESSION['user_phone'] = $active;
         $_SESSION['device_phone'] = $active2;
         $_SESSION['login']="1";
         
         header("location: iot/dashboard.php");
      }else {
