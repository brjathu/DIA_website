...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myrepassword = md5(mysqli_real_escape_string($conn,$_POST['repassword']));
      ...
      if($mypassword != $myrepassword){
          echo "<script type='text/javascript'>alert('passwords mismatch!')</script>";
            ...
            $sql = "SELECT user_name FROM user WHERE user_name = '$myusername'";
            ...
            if($count!=0){
                echo "<script type='text/javascript'>alert('user name already exists!')</script>";
                    ...
                    $sql="INSERT INTO user(user_name,password,email) VALUES ('$myusername','$mypassword','$myemail')";
